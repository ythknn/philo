...
test_one ()
{
    ("/home/ubuntu/Philosphers-42Project-Tester/philo" 4 310 200 100 > "./log_philo")&
    sleep 5
    pkill $1
...
test_two ()
{
    ...
    ("/home/ubuntu/Philosphers-42Project-Tester/philo" 4 410 200 200 > /dev/null)&
    i=1
    error=0
    while [ $i -lt 180 ];do
        printf "\r[%d...]" $i
...
test_three ()
{
    ...
    ("/home/ubuntu/Philosphers-42Project-Tester/philo" 5 800 200 200 > /dev/null)&
    i=1
    error=0
    while [ $i -lt 180 ];do
        printf "\r[%d...]" $i
...
test_four ()
{
    ("/home/ubuntu/Philosphers-42Project-Tester/philo" 4 410 200 200 $3 > "./log_philo")&
    sleep 10
    pgrep $1 > /dev/null
    if [ "$?" -eq 1 ];then
...
if [ "$2" -eq 1 -o "$2" -eq 0 ];then
    ...
    target="philo"
    make -C "/home/ubuntu/philo" > /dev/null
